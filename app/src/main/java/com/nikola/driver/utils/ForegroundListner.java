...
import com.nikola.driver.fcm.FcmBroadcastReceiver;
import com.nikola.driver.fcm.OnBroadcastReceiver;
...
public class ForegroundListner implements Application.ActivityLifecycleCallbacks,ComponentCallbacks2 {
    ...
    public void onActivityDestroyed(Activity activity) {
        ...
        /*if(activity.getClass().getName().equalsIgnoreCase("com.nikola.driver.ui.activity.MainActivity")) {
