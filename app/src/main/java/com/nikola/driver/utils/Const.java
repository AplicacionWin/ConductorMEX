...
//    public static final String GOOGLE_API_KEY = "AIzaSyAh9OgcosLuybd7aEn9B4-huX-RLsxP4ok";
    ...
    public class ServiceType {
        ...
        //public static final String HOST_URL = "http://192.241.129.133";// basic server
        //**public static final String HOST_URL = "http://167.172.108.140";// basic server
        //**public static final String SOCKET_URL = "http://167.172.108.140:3000?type=provider&id="; // socketUrl
        //**public static final String HOST_URL = "http://192.241.129.133";// basic server
        //**public static final String SOCKET_URL = "http://192.241.129.133:3000?type=provider&id="; // socketUrl
        public static final String HOST_URL = "http://colombia.aplicacionwin.com/";// pruebas
        public static final String SOCKET_URL = "http://colombia.aplicacionwin.com:3000?type=provider&id="; // pruebas

        //public static final String HOST_URL = "http://167.172.97.206";// prod server
        //public static final String SOCKET_URL = "http://167.172.97.206:3000?type=provider&id="; // socketUrl
        ...
        public static final String CONSULTAR_EMAIL = BASE_URL + "check-email";
        ...
        public static final String VERIFICAR_EMAIL = BASE_URL+"check-email";
        ...
        public static final String VERIFICAR_BACKEND = "check-email";
    }
    ...
    public static boolean SEND_POSITION_DRIVER = false;
    public static Location locationDriver  = new Location("");
