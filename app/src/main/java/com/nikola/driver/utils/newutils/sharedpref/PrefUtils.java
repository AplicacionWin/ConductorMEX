...
public class PrefUtils {
    ...
    public int getIntValue(String key, int defaultValue) {
        try {
            int d = mSharedPreferences.getInt(key, defaultValue);
            return d;
    ...
    public double getDoubleValue(String key, String defaultValue) {
        try {
            return Double.parseDouble(mSharedPreferences.getString(key, defaultValue));
        }catch (Exception e) {
            return 0.0;
        }
    }
